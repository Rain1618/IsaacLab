...
class ImitationSceneCfg(InteractiveSceneCfg):
    ...
    terrain = TerrainImporterCfg(
        ...
        terrain_generator=ROUGH_TERRAINS_CFG, # TODO: Modify to flat terrain
        max_init_terrain_level=5,
        collision_group=-1,
        physics_material=sim_utils.RigidBodyMaterialCfg( # TODO: Use the same rigidbody definition 
...
@configclass
class ImitationRoughEnvCfg(ManagerBasedRLEnvCfg):
